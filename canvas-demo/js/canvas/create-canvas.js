...
* 从json文件取数据
**/
var dataForCanvas = [];	// 数据源
function getJsonData() {
	/* 这种方式可以取到，但是不能保证一次操作就能完全取到
...
function startCanvas() {
	...
	if (dataForCanvas.length > 0) {
		var _cinemaName = "宇宙无敌嘛咪吽影院";	// 影院名字
		var _schDate = "2015-05-06";	// 排期日期
		...
		_canvas.drawCinemaName(_cinemaName, _canvas.canvasObj, _canvas.canvasID, canvasHeight);	// 绘制影院名字
