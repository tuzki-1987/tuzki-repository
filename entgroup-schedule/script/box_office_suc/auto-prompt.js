...
$(function(){
	...
	$(".filmListBox-ul li").live("click", function(){
		...
		// 同时修改影片名字
		var parentObjId = $(this).parent(".filmListBox-ul").parent(".filmListBox-div").parent().parent().parent().parent().attr("id");
		$("#" + parentObjId).find(".unmatch-film-name").text($(this).text());
	});
